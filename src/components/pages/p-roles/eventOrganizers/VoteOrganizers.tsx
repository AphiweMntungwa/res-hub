            ...
            <DialogContent dividers>
                {step === 1 && (
                    <div className="flex flex-col items-center space-y-4">
                        <p>Would you like to upvote or downvote an Event Organizer?</p>
                ...
                {step === 2 && (
                    <div className="flex flex-col items-center space-y-4">
                        <h2 className="text-xl font-bold">Select a {voteType === "upvote" ? "Resident" : "Current Event Organizer"}</h2>
