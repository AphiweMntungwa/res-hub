...
const VotingDialog = lazy(() => import('@/components/pages/p-roles/eventOrganizers/VoteOrganizers').then(module => ({ default: module.default })));;

export default function CoordinatorList(props: { eventAdmins: Organizer[] }) {
    ...
    return (
        <Grid container spacing={3} justifyContent="center">
            <Grid item xs={12}>
                <OptionsPanel>
                    <Tooltip title="Vote For Event Organizers" arrow>
