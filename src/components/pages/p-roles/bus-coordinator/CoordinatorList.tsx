...
const VotingDialog = lazy(() => import('@/components/pages/p-roles/bus-coordinator/VoteCoordinator').then(module => ({ default: module.default })));;

export default function CoordinatorList(props: { busAdmins: Coordinator[] }) {
    ...
    return (
        <Grid container spacing={3} justifyContent="center">
            <Grid item xs={12}>
                <OptionsPanel>
                    <Tooltip title="Vote For Bus Co-ordinators" arrow>
