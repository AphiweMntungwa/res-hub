...
const VotingDialog = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
    ...
    return (
        <Dialog open={isOpen} onClose={onClose} fullScreen>
            <DialogTitle>
                Vote for an Sports Administrator
                <IconButton
                    aria-label="close"
                    onClick={onClose}
            ...
            <DialogContent dividers>
                {step === 1 && (
                    <div className="flex flex-col items-center space-y-4">
                        <p>Would you like to upvote or downvote a Sports Admin?</p>
                ...
                {step === 2 && (
                    <div className="flex flex-col items-center space-y-4">
                        <h2 className="text-xl font-bold">Select a {voteType === "upvote" ? "Resident" : "Current Sports Admin"}</h2>
