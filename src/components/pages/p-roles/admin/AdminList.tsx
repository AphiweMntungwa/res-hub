...
const VotingDialog = lazy(() => import('@/components/pages/p-roles/admin/VoteAdminsDialog').then(module => ({ default: module.default })));;

export default function AdminList(props: { admins: Admin[] }) {
    ...
    return (
        <Grid container spacing={3} justifyContent="center">
            <Grid item xs={12}>
                <OptionsPanel>
                    <Tooltip title="Vote In Admin" arrow>
            ...
            {props.admins.map((admin) => (
                <Grid item xs={12} sm={12} md={12} key={admin.id}>
                    <StyledCard>
                        <CardHeader
